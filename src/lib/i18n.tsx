...
const dictionaries: Record<Lang, Dict> = {
  pt: {
    ...
    "projects.p2.desc": "Atuei de ponta a ponta no ciclo de vida da aplicação. Fui a principal responsável por projetar a nova arquitetura do sistema, desmembrando um modelo monolítico em uma estrutura moderna baseada em microsserviços. Construí as fundações do back-end em Java com Spring Boot, implementando a comunicação assíncrona com RabbitMQ e segurança via Keycloak. Além da infraestrutura e back-end, atuei diretamente no front-end, desenvolvendo a interface com React e TypeScript para assegurar a integração perfeita com as APIs construídas.",
    "projects.p2.problem": "A aplicação  sofria com gargalos de escalabilidade e complexidade de manutenção devido à arquitetura monolítica, dificultando a implementação de novas métricas e o registro ágil de horas de apontamento da equipe.",
    "projects.p2.solution": "Projetei e executei a transição para uma arquitetura orientada a microsserviços conteinerizados com Docker. Separei os domínios da aplicação, utilizando RabbitMQ para o processamento assíncrono de dados e Keycloak para centralizar e blindar a autenticação.",
    "projects.p2.challenges": "O principal desafio foi garantir a consistência dos dados distribuídos e orquestrar a comunicação entre os microsserviços sem perdas",
    "projects.p2.results":  "Entrega de uma plataforma altamente resiliente e de fácil manutenção. A nova arquitetura eliminou gargalos de performance, escalou o processamento de apontamentos e permitiu uma esteira de desenvolvimento muito mais fluida e segura para o time.",
    "projects.p3.context": "",
    "projects.p3.desc": "",
    "projects.p3.problem": "",
